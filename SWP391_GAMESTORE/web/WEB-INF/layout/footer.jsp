			...
			<div class="row">
				<div class="col-lg-4">
					<div class="footer-logo text-white">
                                          <img src="../template/img/logo2.png" alt="">
				...
				<div class="col-lg-4 col-md-6">
					<div class="footer-widget mb-5 mb-md-0">
						...
						<div class="latest-blog">
							<div class="lb-item">
								<div class="lb-thumb set-bg" data-setbg="../template/img/latest-blog/1.jpg"></div>
							...
							<div class="lb-item">
								<div class="lb-thumb set-bg" data-setbg="../template/img/latest-blog/2.jpg"></div>
								<div class="lb-content">
									<div class="lb-date">June 21, 2018</div>
									<p>Lorem ipsum dolor sit amet, consectetur adipisc ing ipsum </p>
									<a href="#" class="lb-author">By Admin</a>
							...
							<div class="lb-item">
								<div class="lb-thumb set-bg" data-setbg="../template/img/latest-blog/3.jpg"></div>
								<div class="lb-content">
									<div class="lb-date">June 21, 2018</div>
									<p>Lorem ipsum dolor sit amet, consectetur adipisc ing ipsum </p>
									<a href="#" class="lb-author">By Admin</a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__about__logo">
                        <a href="./index.jsp"><img src="<c:url value="/img/logo1.png" />" alt=""></a>
                    </div>
                    <ul>
                        <li>Address: FPT University HCM</li>
                        <li>Phone: +84 765.xxx.xxx </li>
                        <li>Email: CUONGHCSE150679@fpt.edu.vn</li>
                    </ul>
                </div>
            </div>
                ...
                <div class="footer__copyright">
                    <div class="footer__copyright__text">
                        <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                         <!--   Copyright &copy; SWP391. All Rights Reserved
                            
                        </p>
                    </div>    
                    <div class="footer__copyright__text authority">
                        <p><i class="fa fa-heart" aria-hidden="true"></i> Made by <a href="https://colorlib.com" target="_blank">TEAM 5</a></p> 
                    </div>
                </div>
            </div>
        </div>
